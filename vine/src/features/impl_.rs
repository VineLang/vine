...
use crate::{
  ...
  structures::{
    ...
    chart::{
      ConcreteConstDef, ConcreteFnDef, ConstId, DefId, DefImplKind, DefValueKind, DirectImplDef,
      DirectImplId, FnId, GenericsId, ImplId, ImplSubitem, ImplSubitemKind, IndirectImplDef,
      IndirectImplId,
    },
    diag::Diag,
