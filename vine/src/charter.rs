...
impl<'core> Charter<'core, '_> {
  ...
  fn chart_builtin(
    ...
    match builtin {
      ...
      Builtin::IOError => set(primitive(self, Type::IOError), &mut self.chart.builtins.ioerror),
      Builtin::File => set(primitive(self, Type::File), &mut self.chart.builtins.file),
      Builtin::PathBuf => set(primitive(self, Type::PathBuf), &mut self.chart.builtins.pathbuf),
